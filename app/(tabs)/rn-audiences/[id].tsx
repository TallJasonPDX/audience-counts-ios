...
export default function RNAudienceDetailScreen() {
  ...
  useEffect(() => {
    ...
    const foundAudience = audiences.find((a: any) => a.id.toString() === id);
    ...
    <ThemedView style={styles.container}>
      ...
      {audience.filters && (
        <View style={styles.section}>
          ...
          {audience.filters.specialties &&
            audience.filters.specialties.length > 0 && (
              <View style={styles.filterItem}>
                <ThemedText type="defaultSemiBold">Specialties:</ThemedText>
                <ThemedText>
          ...
          {audience.filters.states && audience.filters.states.length > 0 && (
            <View style={styles.filterItem}>
              <ThemedText type="defaultSemiBold">States:</ThemedText>
              <ThemedText>{audience.filters.states.join(", ")}</ThemedText>
            </View>
          )}

          {audience.filters.geo_logic && (
            <View style={styles.filterItem}>
              <ThemedText type="defaultSemiBold">Geographic Logic:</ThemedText>
      ...
      <View style={styles.buttonContainer}>
        <Button
          title="Edit Audience"
          onPress={() => router.push(`/rn-audiences/edit/${audience.id}`)}
          style={styles.button}
        />
